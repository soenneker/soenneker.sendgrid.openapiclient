...
#nullable restore
        ...
        public async Task<List<global::Soenneker.SendGrid.OpenApiClient.Models.IpWarmup200Item>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Soenneker.SendGrid.OpenApiClient.Models.IpWarmup200Item>(requestInfo, global::Soenneker.SendGrid.OpenApiClient.Models.IpWarmup200Item.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
