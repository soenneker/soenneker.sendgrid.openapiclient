...
{
    /// <summary>
    /// Builds and executes requests for operations under \tsg_subusers_v3\v3\subusers\{subuser_name}\ips
    /// </summary>
    ...
    public partial class IpsRequestBuilder : BaseRequestBuilder
    {
        ...
        public IpsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tsg_subusers_v3/v3/subusers/{subuser_name}/ips", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.SendGrid.OpenApiClient.Tsg_subusers_v3.V3.Subusers.Item.Ips.IpsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IpsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/tsg_subusers_v3/v3/subusers/{subuser_name}/ips", rawUrl)
        {
        }
        /// <summary>
